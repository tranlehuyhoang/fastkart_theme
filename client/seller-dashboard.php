                        ...
                        <div class="profile-contain">
                            <div class="profile-image">
                                <div class="position-relative">
                                    <img src="assets/images/vendor-page/logo.png" class="blur-up lazyload update_img"
                                        alt="">
                                </div>
                            </div>
                                    ...
                                    <div class="row g-sm-4 g-3">
                                        <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                            <div class="totle-contain">
                                                <img src="assets/images/svg/order.svg" class="img-1 blur-up lazyload"
                                                    alt="">
                                        ...
                                        <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                            <div class="totle-contain">
                                                <img src="assets/images/svg/pending.svg" class="img-1 blur-up lazyload"
                                                    alt="">
                                        ...
                                        <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                            <div class="totle-contain">
                                                <img src="assets/images/svg/wishlist.svg" class="img-1 blur-up lazyload"
                                                    alt="">
                                                <img src="assets/images/svg/wishlist.svg" class="blur-up lazyload"
                                                    alt="">
                                                <div class="totle-detail">
                                                    <h5>Order Pending</h5>
                                                    <h3>36</h3>
                                ...
                                <div class="table-responsive dashboard-bg-box">
                                    <table class="table product-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="product-image">
                                                    <img src="assets/images/vegetable/product/3.png" class="img-fluid"
                                                        alt="">
                                                </td>
                                                <td>
                                                    <h6>Yumitos Chilli Sprinkled Potato Chips 100 g</h6>
                                            ...
                                            <tr>
                                                <td class="product-image">
                                                    <img src="assets/images/vegetable/product/4.png" class="img-fluid"
                                                        alt="">
                                                </td>
                                                <td>
                                                    <h6>healthy Long Life Toned Milk 1 L</h6>
                                            ...
                                            <tr>
                                                <td class="product-image">
                                                    <img src="assets/images/vegetable/product/5.png" class="img-fluid"
                                                        alt="">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="product-image">
                                                    <img src="assets/images/vegetable/product/6.png" class="img-fluid"
                                                        alt="">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="product-image">
                                                    <img src="assets/images/vegetable/product/7.png" class="img-fluid"
                                                        alt="">
                                                </td>
                                                <td>
